...
**** TODO Make Champs Sous Vide Pork 2 variables
...
**** TODO Setup Cutting to evaluate SV Chicken variables.
...
**** TODO Make Champs queso samples option 1
  ...
  - Queso – Two separate paths here Option 1
    ...
    - I also want to substitute the green chiles for roasted poblanos.
**** TODO Make Champs queso samples option 2
  ...
  - Queso Option 2 Changing cheese to Bongard and Pepper Jack blend.
    ...
    - Substitute the green chiles for roasted poblanos
...
**** TODO Make samples of champs black beans
     SCHEDULED: <2017-06-14 Wed>
...
*** [2017-06-13 Tue 09:23]
 - Champs will pursue a black bean option
**** TODO Make samples of champs pinto beans
     SCHEDULED: <2017-06-14 Wed>
 - Reduce slurry viscosity. Too slimy!
